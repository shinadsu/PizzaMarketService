    ...
    public partial class EditDatabse : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategory", x => new { x.CategoriesId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductIngredients", x => new { x.IngredientsId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderOrderItems", x => new { x.OrderId, x.OrderItemsId });
                    table.ForeignKey(
                        name: "FK_OrderOrderItems_orderItems_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderOrderItems_OrderItemsId",
